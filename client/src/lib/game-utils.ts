 ...
 */
export function calculatePotentialScore(dice: DiceRoll, category: ScoreCategory): number {
 ...
 */
export function qualifiesForCategory(dice: DiceRoll, category: ScoreCategory): boolean {
 ...
 */
export function calculateTotalScore(scoreCard: Record<ScoreCategory, number | undefined>): number {
